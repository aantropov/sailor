...
namespace Sailor
{
	...
	inline constexpr uint32_t RuntimeGIProbesHardMaxWorkerCount = 2u;
	...
	struct SAILOR_SHARED_API RuntimeGIProbesQualitySettings final
	{
		...
		uint32_t m_clipmapCascadeCount = 1u;
		uint32_t m_initialSamplesPerProbe = 16u;
		uint32_t m_targetSamplesPerProbe = 64u;
		uint32_t m_workerCount = 1u;
		...
		float m_maxPublicationsPerSecond = 2.0f;
