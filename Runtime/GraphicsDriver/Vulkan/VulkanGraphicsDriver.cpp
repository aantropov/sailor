	...
	glm::vec4 clearColor)
{
	...
	cmd->m_vulkan.m_commandBuffer->BeginRenderPassEx(attachments, depthStencilAttachment->m_vulkan.m_imageView, rect, 0, VkOffset2D{.x = offset.x, .y = offset.y}, bClearRenderTargets);
}
