...
namespace Sailor
{
	...
	public:
		...
		SAILOR_API virtual void Process(TVector<RHI::RHICommandListPtr>& transferCommandLists, RHI::RHICommandListPtr commandLists, const RHI::RHISceneViewSnapshot& sceneView) override;
