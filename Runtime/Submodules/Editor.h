...
namespace Sailor
{
	...
	public:
		...
		SAILOR_SHARED_API bool StartProbeVolumeBake(
			const EditorProbeVolumeBakeRequest& request,
			std::string& outDiagnostic);
		SAILOR_SHARED_API bool CancelProbeVolumeBake(
			std::string& outDiagnostic);
		SAILOR_SHARED_API EditorProbeVolumeBakeStatus
			GetProbeVolumeBakeStatus() const;
	...
	protected:
		...
		TUniquePtr<GlobalIlluminationBakeController> m_probeVolumeBakeController{};
